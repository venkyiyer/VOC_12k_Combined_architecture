...
class KittiSource:
    ...
    def load_trainval_data(self, data_dir, valid_fraction):
        ...
        for voc_id in ['VOC/']:
            root = voc_id
            annot = self._build_annotation_list(root,'train_11328') # Exp_train  training_2330
            annot_valid = self._build_annotation_val_list(root, 'val_602') # Exp_valid
            train_annot += annot
    ...
    def load_test_data(self, data_dir):
        ...
        """
        root = data_dir + '/'
        annot_test = self.__build_annotation_test_list(root, 'test_101') # Exp_testing
